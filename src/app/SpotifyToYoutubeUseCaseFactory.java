...
public class SpotifyToYoutubeUseCaseFactory {
    ...
    public static SpotifyToYoutubeView create(ViewManagerModel viewManagerModel, SpotifyToYoutubeViewModel spotifyToYoutubeViewModel, SpotifyToYoutubeDataAccessInterface userDataAccessObject, SpotifyToYoutubeDataAccessInterfaceForSpotify userDataAccessObject_2) {
    ...
    private static SpotifyToYoutubeController createSpotifyToYTUseCase(ViewManagerModel viewManagerModel, SpotifyToYoutubeViewModel spotifyToYoutubeViewModel, SpotifyToYoutubeDataAccessInterface userDataAccessObject, SpotifyToYoutubeDataAccessInterfaceForSpotify userDataAccessObject_2) throws IOException {
