...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, SignupUserDataAccessInterface userDataAccessObject, ClearUserDataAccessInterface secondUserDataAccessObject) {

        try {
            SignupController signupController = createUserSignupUseCase(viewManagerModel, signupViewModel, loginViewModel, userDataAccessObject);
            ClearController clearController = createClear(clearViewModel,secondUserDataAccessObject);
    ...
    public static ClearController createClear(ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject){
